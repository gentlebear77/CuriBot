...
def replay_demo(demo_data):
    ...
    episode_length = len(demo_data['action'])
    for step in range(1, episode_length):
        action = demo_data["action"][step-1]
        # print("base_action", base_action)
        next_state, _, done, extra = robot.step(action)
...
if __name__ == "__main__":
    ...
    video = False
    fine_alignment = True
    video_name = 'banana_origin'
    with open('/home/gentlebear/Mres/DIAYN-PyTorch/demo_buffer/learned_can_demo.pkl', 'rb') as f:
    ...
    robot = CubeEnv(Test_env=True, render=True)
    ...
    while 1:
        ...
        while error > ERR_THRESHOLD:
            ...
            # points1 = [(84, 116), (92, 108), (84, 104), (80, 120), (84, 108), (96, 116), (92, 116), (84, 112)]
            # points2 = [(40, 88), (72, 84), (44, 76), (32, 92), (44, 80), (76, 92), (72, 92), (40, 84)]
            ...
            print(f'points1 after removing common points: {points1}, points2 after removing common points: {points2}')
            ...
            #Move robot
            if video:
                robot.Videosave_start(video_name=video_name)
            robot_move(t,R)
